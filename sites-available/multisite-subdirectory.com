server {
	...
	root /var/www/multisite-subdirectory.com;

	# File to be used as index
	index index.php;

	# Overrides logs defined in nginx.conf, allows per site logs.
	access_log /var/log/nginx/multisite-subdirectory.com.access.log;
	error_log  /var/log/nginx/multisite-subdirectory.com.error.log debug;
